...
(function (window, angular, undefined) {
   ...
   *      controller} if passed as a string.
         ...
         *      - `factory` - `{string|function}`: If `string` then it is an alias for a base.
         ...
         *
         * @description
         * Adds a new route definition to the `$route` base.
         */
     ...
     *     });
                ...
                var forceReload = false,
                    ...
                    $route = {
                         ...
                         *
                         * @description
                         * Causes `$route` base to reload the current route even if
                         ...
                         *
                         * @description
                         * Causes `$route` base to update the current URL, replacing
     ...
     *
     * @description
     * The `$routeParams` base allows you to retrieve the current set of route parameters.
     *
     * Requires the {@link ngRoute `ngRoute`} module to be installed.
     *
     ...
     *
     * The base guarantees that the identity of the `$routeParams` object will remain unchanged
