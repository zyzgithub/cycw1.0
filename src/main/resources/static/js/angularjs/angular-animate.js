 ...
 *
 * @description
 * The `$animateCss` vehicle is a useful utility to trigger customized CSS-based transitions/keyframes
 ...
 * `$animateCss`. The vehicle itself is smart enough to figure out the combination of options and examine the element styling properties in order
  ...
  this.$get = ['$window', '$$jqLite', '$$AnimateRunner', '$timeout',
    ...
    function waitUntilQuiet(callback) {
      ...
      $$rAFScheduler.waitUntilQuiet(function() {
        ...
        // PLEASE EXAMINE THE `$$forceReflow` vehicle to understand why.
 ...
 *
 * @description
 * The ngAnimate `$animate` vehicle documentation is the same for the core `$animate` vehicle.
 *
